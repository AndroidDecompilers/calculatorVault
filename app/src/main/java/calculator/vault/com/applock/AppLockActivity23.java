...
public class AppLockActivity23 extends AppCompatActivity {
    long f9751A;
...
//                camera.takePicture(f9775Y, null, aa);
    ...
    Vibrator f9789m;
    int f9790n;
    AuthticationCallBackResults f9791o;
    FrameLayout f9792p;
    int f9793q;
    int f9794r;
    Window f9795s;
    ...
    class C30941 extends HashMap<String, Integer> {
        final /* synthetic */ AppLockActivity23 f9721a;

        C30941(AppLockActivity23 appLockActivity) {
    ...
    class C30962 implements OnClickListener {
        final /* synthetic */ AppLockActivity23 f9737a;

        C30962(AppLockActivity23 appLockActivity) {
    ...
    class C31005 extends BroadcastReceiver {
        final /* synthetic */ AppLockActivity23 f9744a;

        C31005(AppLockActivity23 appLockActivity) {
    ...
    class C31016 implements OnClickListener {
        final /* synthetic */ AppLockActivity23 f9745a;

        C31016(AppLockActivity23 appLockActivity) {
        ...
        public void onClick(View view) {
            if (!this.f9745a.f9771U) {
                ...
                AppLockActivity23 appLockActivity;
                switch (view.getId()) {
                    case R.id.rl1:
    ...
    class C31027 implements OnClickListener {
        final /* synthetic */ AppLockActivity23 f9746a;

        C31027(AppLockActivity23 appLockActivity) {
    ...
    class C31038 implements OnClickListener {
        final /* synthetic */ AppLockActivity23 f9747a;

        C31038(AppLockActivity23 appLockActivity) {
    ...
    class C31049 implements OnClickListener {
        final /* synthetic */ AppLockActivity23 f9748a;

        C31049(AppLockActivity23 appLockActivity) {
    ...
    private class C3106a extends AsyncTask<Void, Void, Drawable> {
        final /* synthetic */ AppLockActivity23 f9750a;

        class C31051 implements Runnable {
            final /* synthetic */ AppLockActivity23.C3106a f9749a;

            C31051(AppLockActivity23.C3106a c3106a) {
                this.f9749a = c3106a;
            }
        ...
        private C3106a(AppLockActivity23 appLockActivity) {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        findViewById(R.id.rlThemeIcon).setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                final Dialog dialog = new Dialog(AppLockActivity23.this);
                ...
                gridView.setAdapter(new C1584f(AppLockActivity23.this, iArr, f9790n));
        ...
        if (this.f9778b.getBoolean("isFinger", false)) {
            ...
            if (!this.keyguardManager.isKeyguardSecure() && !this.fingerprintManager.hasEnrolledFingerprints()) {
                ...
                if (cipherInit()) {
                    ...
                    this.f9791o = new AuthticationCallBackResults(this);
                    this.f9791o.m14842a(this.fingerprintManager, this.cryptoObject, new AuthticationCallBackResults.OnResultReciver() {
                        @Override
                    ...
                    findViewById(R.id.tvForget).setVisibility(View.GONE);
    ...
    protected void onPause() {
        if (!(this.f9791o == null || this.f9791o.f9992a == null)) {
            this.f9791o.m14841a();
        }
        super.onPause();
    }
